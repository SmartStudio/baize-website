...
cover: ./media/deploy-website-to-cloudflare-cover.png
draft: false
howto:
...
import cfFig from './media/deploy-website-to-cloudflare-fig.png'

<Figure src={cfFig} alt="Cloudflare Pages 四步部署流水线示意:连接仓库、配置构建、首次部署、绑定域名" caption="图：把网站部署到 Cloudflare Pages 的四步——连接仓库、配置构建、首次部署、绑定域名，一条流水线走完。" width="wide" border />
