...
import loopFig from './media/what-is-loop-engineering-fig.png'

<Figure src={loopFig} alt="Loop Engineering 的计划-执行-观察-纠正闭环示意" caption="图：Loop Engineering 把「计划 → 执行 → 观察 → 纠正」连成一条闭环，每一轮都比上一轮更准，达标才交付。" width="wide" border />
...
相关：[第一套 AI 编程工作流](/notes/design-first-ai-dev-workflow/)、[想法到产品](/notes/idea-to-product-delivery/)。
