...
The Service uses a prepaid credits model: you purchase credits in advance, and usage is deducted from your balance as you make API calls. Specific pricing, free-tier limits, and refund rules are governed by the live pricing page within the product.
